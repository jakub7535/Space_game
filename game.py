...
from player import Player, Resources_Obstacles
...
class Game:
    ...
    resources_obstacles =[ 
           ...
           {"img":"laser.png", "sound":"explosion.wav", "size":80, "life":-15, "score":0},
           {"img":"diamond.png", "sound":"explosion.wav", "size":120, "life":0, "score":30}
        ]
    ...
    def update_resources_obtacles_positions(self, screen_height):
